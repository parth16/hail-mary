...
- PR #45: Underwriting score factors should carry explicit support status, missing inputs, and evidence IDs into both deterministic and final memos. Stage keyword matching should check specific phrases such as pre-seed before broader words such as seed.
